...
fun RegistrationScreen() {
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            TextButton(onClick = {
                mContext.startActivity(Intent(mContext, politicas::class.java))
            }) {
                Text(text = stringResource(R.string.titleButomPrivacity
                ))
            }
        }
        ...
        Box(modifier = Modifier.align(Alignment.CenterHorizontally)) {
            Button(
                onClick = {
                          mContext.startActivity(Intent(mContext, Menu::class.java))
                },
